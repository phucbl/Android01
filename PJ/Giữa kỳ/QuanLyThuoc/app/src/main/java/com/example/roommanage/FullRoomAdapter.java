...
public class FullRoomAdapter extends BaseAdapter {
    private FullRoom context;
    private int layout;
    private List<Room> roomList;

    public FullRoomAdapter(FullRoom context, int layout, List<Room> roomList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        FullRoomAdapter.ViewHolder holder;
        if(view == null){
            holder = new FullRoomAdapter.ViewHolder();
            ...
            holder = (FullRoomAdapter.ViewHolder) view.getTag();
        }
