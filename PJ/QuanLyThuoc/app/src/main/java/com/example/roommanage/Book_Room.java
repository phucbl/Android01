...
public class Book_Room extends AppCompatActivity {
    ...
    String urladd = "http://192.168.137.177/qldp/public/api/addThongTinPhong";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.CHITIETBANHANG);
        ...
        btnXong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(hoten.isEmpty() || quoctich.isEmpty() || ngaydat.isEmpty() || songayo.isEmpty() || maphong.isEmpty()){
                    ...
                    BookRoom(urladd);
                    startActivity(new Intent(Book_Room.this, Show1Phieu.class));
                }
            }
        });
